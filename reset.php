...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Mohon masukkan password yang baru.";     
    } elseif(strlen(trim($_POST["new_password"])) < 6){
        $new_password_err = "Password harus terdiri minimal 6 karakter.";
    } else{
...
<body>
    <div class="wrapper">
        ...
        <p>Mohon isi form dibawah ini untuk mereset password.</p>
