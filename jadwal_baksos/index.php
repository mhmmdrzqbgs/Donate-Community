...
<head>
    <meta charset="UTF-8">
    <title>Jadwal Bhakti Sosial</title>
            ...
            <div class="row">
                ...
                <div class="page-header">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Jadwal Kegiatan Bhakti Sosial<br/>Komunitas Sosial</h2><br/><br/>
                        <br/><br/><p>Penanggung Jawab Tabel</p>
                        <p>Nama : Bangga Aditya Ardiansyah</p>
                        <p>NIM : 202251091</p>
                        <a href="tambah.php" class="btn btn-success pull-right">Tambah Jadwal</a>
                    </div>
                    <?php
                    require_once "koneksi.php";

                    $sql = "SELECT * FROM tb_jadwal1";
