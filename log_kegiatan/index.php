            ...
            <div class="row">
                ...
                <div class="page-header">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Log-book<br/>Komunitas Sosial</h2><br/><br/>
                        <br/><br/><p>Penanggung Jawab Tabel</p>
                        <p>Nama : Mahir Mahendra</p>
                        <p>NIM : 202251059</p>
                        <a href="tambah.php" class="btn btn-success pull-right">Tambah Catatan</a>
                    </div>
                    <?php
